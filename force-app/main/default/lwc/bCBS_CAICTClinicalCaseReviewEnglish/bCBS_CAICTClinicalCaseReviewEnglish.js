...
import { OMNIDEF } from './bCBS_CAICTClinicalCaseReviewEnglish_def.js';
import tmpl from './bCBS_CAICTClinicalCaseReviewEnglish.html';
import tmpl_nds from './bCBS_CAICTClinicalCaseReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCBS_CAICTClinicalCaseReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
